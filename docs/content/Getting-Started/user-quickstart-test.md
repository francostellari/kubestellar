...
```shell
KUBECONFIG=ks-core.kubeconfig kubectl ws $MB1
while ! KUBECONFIG=ks-core.kubeconfig get ServiceAccount sa-test ; do
    sleep 10
done
KUBECONFIG=ks-core.kubeconfig kubectl ws $MB2
while ! KUBECONFIG=ks-core.kubeconfig get ServiceAccount sa-test ; do
    sleep 10
done
```
